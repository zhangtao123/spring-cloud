...
public class WarehouseLevelVO {
     ...
     * 递归查询（子仓库）
     */
    private List<WarehouseLevelVO> children;
     ...
     */
    public List<WarehouseLevelVO> getChildren() {
        return children;
    }
     ...
     */
    public void setChildren(List<WarehouseLevelVO> children) {
